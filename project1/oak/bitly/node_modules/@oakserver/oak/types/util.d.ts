...
import type { Data, ErrorStatus, Key, RedirectStatus } from "./types";
...
export declare function isErrorStatus(value: Status): value is ErrorStatus;
/** Determines if a HTTP `Status` is a `RedirectStatus` (3XX). */
export declare function isRedirectStatus(value: Status): value is RedirectStatus;
