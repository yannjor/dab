...
export declare type ResponseBody = string | number | bigint | boolean | symbol | object | undefined | null;
export declare type ResponseBodyFunction = () => ResponseBody | Promise<ResponseBody>;
...
export declare function convertBodyToBodyInit(body: ResponseBody | ResponseBodyFunction, type?: string): Promise<[dntShim.BodyInit | undefined, string | undefined]>;
