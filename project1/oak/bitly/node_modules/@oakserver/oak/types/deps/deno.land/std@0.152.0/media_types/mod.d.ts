...
declare type DB = typeof db;
declare type ContentTypeToExtension = {
    [K in keyof DB]: DB[K] extends {
        "extensions": readonly string[];
    } ? DB[K]["extensions"][number] : never;
};
declare type KnownExtensionOrType = keyof ContentTypeToExtension | ContentTypeToExtension[keyof ContentTypeToExtension] | `.${ContentTypeToExtension[keyof ContentTypeToExtension]}`;
