 ...
 * ```
 */
export declare function readerFromIterable(iterable: Iterable<Uint8Array> | AsyncIterable<Uint8Array>): dntShim.Deno.Reader;
/** Create a `Writer` from a `WritableStreamDefaultWriter`. */
export declare function writerFromStreamWriter(streamWriter: WritableStreamDefaultWriter<Uint8Array>): dntShim.Deno.Writer;
/** Create a `Reader` from a `ReadableStreamDefaultReader`. */
export declare function readerFromStreamReader(streamReader: ReadableStreamDefaultReader<Uint8Array>): dntShim.Deno.Reader;
...
export declare function writableStreamFromWriter(writer: dntShim.Deno.Writer, options?: WritableStreamFromWriterOptions): WritableStream<Uint8Array>;
 ...
 * ```
 */
export declare function readableStreamFromIterable<T>(iterable: Iterable<T> | AsyncIterable<T>): dntShim.ReadableStream<T>;
/**
 ...
 * ```
 */
export declare function readAll(r: dntShim.Deno.Reader): Promise<Uint8Array>;
 ...
 * ```
 */
export declare function readAllSync(r: dntShim.Deno.ReaderSync): Uint8Array;
 ...
 * ```
 */
export declare function writeAll(w: dntShim.Deno.Writer, arr: Uint8Array): Promise<void>;
 ...
 * ```
 */
export declare function writeAllSync(w: dntShim.Deno.WriterSync, arr: Uint8Array): void;
 ...
 */
export declare function iterateReader(r: dntShim.Deno.Reader, options?: {
    bufSize?: number;
 ...
 * next iteration will overwrite contents of previously returned chunk.
 */
export declare function iterateReaderSync(r: dntShim.Deno.ReaderSync, options?: {
    bufSize?: number;
 ...
 */
export declare function copy(src: dntShim.Deno.Reader, dst: dntShim.Deno.Writer, options?: {
    bufSize?: number;
}): Promise<number>;
