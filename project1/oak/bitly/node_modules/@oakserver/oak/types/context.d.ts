...
import { ServerSentEventTargetOptions } from "./server_sent_event.js";
import type { ServerSentEventTarget } from "./server_sent_event.js";
import type { ErrorStatus, ServerRequest, UpgradeWebSocketOptions } from "./types";
...
export declare class Context<S extends AS = State, AS extends State = Record<string, any>> {
     ...
     */
    state: S;
    constructor(app: Application<AS>, serverRequest: ServerRequest, state: S, secure?: boolean);
     ...
     * ```
     */
    assert(condition: any, errorStatus?: ErrorStatus, message?: string, props?: Record<string, unknown>): asserts condition;
