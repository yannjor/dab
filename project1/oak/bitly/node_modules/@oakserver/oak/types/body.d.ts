...
export declare type Body = BodyBytes | BodyJson | BodyForm | BodyFormData | BodyText | BodyUndefined;
...
export declare class RequestBody {
    #private;
    constructor({ body, readBody }: ServerRequestBody, headers: dntShim.Headers);
