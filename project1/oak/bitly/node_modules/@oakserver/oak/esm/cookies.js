...
export class Cookies {
    ...
    async *entries() {
        const keys = __classPrivateFieldGet(this, _Cookies_instances, "m", _Cookies_requestKeys).call(this);
    ...
    async get(name, options = {}) {
        const signed = options.signed ?? !!__classPrivateFieldGet(this, _Cookies_keys, "f");
        const nameSig = `${name}.sig`;
        const header = __classPrivateFieldGet(this, _Cookies_request, "f").headers.get("cookie");
        if (!header) {
            return;
        }
        ...
        const index = await __classPrivateFieldGet(this, _Cookies_keys, "f").indexOf(data, digest);
        if (index < 0) {
            ...
            if (index) {
                ...
                this.set(nameSig, await __classPrivateFieldGet(this, _Cookies_keys, "f").sign(data), { signed: false });
            }
            return value;
        }
    }
    ...
    async set(name, value, options = {}) {
        const request = __classPrivateFieldGet(this, _Cookies_request, "f");
        const response = __classPrivateFieldGet(this, _Cookies_response, "f");
        const headers = [];
        ...
        const secure = __classPrivateFieldGet(this, _Cookies_secure, "f") !== undefined ? __classPrivateFieldGet(this, _Cookies_secure, "f") : request.secure;
        const signed = options.signed ?? !!__classPrivateFieldGet(this, _Cookies_keys, "f");
        ...
        if (signed) {
            ...
            cookie.value = await __classPrivateFieldGet(this, _Cookies_keys, "f").sign(cookie.toString());
            cookie.name += ".sig";
            pushCookie(headers, cookie);
        }
    ...
    async *[(_Cookies_cookieKeys = new WeakMap(), _Cookies_keys = new WeakMap(), _Cookies_request = new WeakMap(), _Cookies_response = new WeakMap(), _Cookies_secure = new WeakMap(), _Cookies_instances = new WeakSet(), _Cookies_requestKeys = function _Cookies_requestKeys() {
        ...
        const result = __classPrivateFieldSet(this, _Cookies_cookieKeys, [], "f");
        const header = __classPrivateFieldGet(this, _Cookies_request, "f").headers.get("cookie");
        if (!header) {
            return result;
        }
