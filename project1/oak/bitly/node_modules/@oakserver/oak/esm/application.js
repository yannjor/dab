...
import { STATUS_TEXT } from "./deps.js";
import { FlashServer } from "./http_server_flash.js";
...
export class Application extends EventTarget {
    constructor(options = {}) {
        ...
        Object.defineProperty(this, "handle", {
            ...
            value: (async (request, secureOrConn, secure = false) => {
                ...
                const context = new Context(this, contextRequest, __classPrivateFieldGet(this, _Application_instances, "m", _Application_getContextState).call(this), secure);
                try {
    ...
    async function _Application_handleRequest(request, secure, state) {
        const context = new Context(this, request, __classPrivateFieldGet(this, _Application_instances, "m", _Application_getContextState).call(this), secure);
        let resolve;
