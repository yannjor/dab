...
import { createHttpError } from "./deps.js";
import { Request } from "./request.js";
import { Response } from "./response.js";
import { send } from "./send.js";
import { SSEStreamTarget, } from "./server_sent_event.js";
...
export class Context {
    ...
    sendEvents(options) {
        if (!__classPrivateFieldGet(this, _Context_sse, "f")) {
            __classPrivateFieldSet(this, _Context_sse, new SSEStreamTarget(this, options), "f");
        }
