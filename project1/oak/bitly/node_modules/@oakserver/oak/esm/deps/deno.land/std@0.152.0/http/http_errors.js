...
import { isClientErrorStatus, Status, STATUS_TEXT, } from "./http_status.js";
...
export class HttpError extends Error {
    constructor(message = "Http Error", options) {
        ...
        _HttpError_status.set(this, Status.InternalServerError);
        _HttpError_expose.set(this, void 0);
        _HttpError_headers.set(this, void 0);
        __classPrivateFieldSet(this, _HttpError_expose, options?.expose === undefined
            ? isClientErrorStatus(this.status)
            : options.expose, "f");
        if (options?.headers) {
            __classPrivateFieldSet(this, _HttpError_headers, new dntShim.Headers(options.headers), "f");
        }
    }
     ...
     * `false`. */
    get expose() {
        return __classPrivateFieldGet(this, _HttpError_expose, "f");
    }
    /** The optional headers object that is set on the error. */
    get headers() {
        return __classPrivateFieldGet(this, _HttpError_headers, "f");
    }
    /** The error status that is set on the error. */
    get status() {
        return __classPrivateFieldGet(this, _HttpError_status, "f");
    }
}
