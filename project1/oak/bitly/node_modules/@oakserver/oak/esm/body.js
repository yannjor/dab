...
import { errors, readerFromStreamReader } from "./deps.js";
...
_RequestBody_body = new WeakMap(), _RequestBody_formDataReader = new WeakMap(), _RequestBody_headers = new WeakMap(), _RequestBody_stream = new WeakMap(), _RequestBody_readAllBody = new WeakMap(), _RequestBody_readBody = new WeakMap(), _RequestBody_type = new WeakMap(), _RequestBody_instances = new WeakSet(), _RequestBody_exceedsLimit = function _RequestBody_exceedsLimit(limit) {
    ...
    const contentLength = __classPrivateFieldGet(this, _RequestBody_headers, "f").get("content-length");
    if (!contentLength) {
        return true;
    }
    ...
    switch (type) {
        ...
        case "json":
            ...
            return async () => JSON.parse(decoder.decode(await __classPrivateFieldGet(this, _RequestBody_instances, "m", _RequestBody_valuePromise).call(this)));
        case "bytes":
            __classPrivateFieldSet(this, _RequestBody_type, "bytes", "f");
            if (__classPrivateFieldGet(this, _RequestBody_instances, "m", _RequestBody_exceedsLimit).call(this, limit)) {
                return () => Promise.reject(new RangeError(`Body exceeds a limit of ${limit}.`));
        ...
        case "text":
            ...
            return async () => decoder.decode(await __classPrivateFieldGet(this, _RequestBody_instances, "m", _RequestBody_valuePromise).call(this));
        default:
