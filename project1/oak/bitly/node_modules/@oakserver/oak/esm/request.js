...
import { accepts, acceptsEncodings, acceptsLanguages } from "./deps.js";
...
export class Request {
    constructor(serverRequest, proxy = false, secure = false) {
        ...
        __classPrivateFieldSet(this, _Request_body, new RequestBody(serverRequest.getBody(), serverRequest.headers), "f");
    }
