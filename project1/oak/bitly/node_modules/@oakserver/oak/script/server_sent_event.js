...
class ServerSentEvent extends Event {
    ...
    constructor(type, data, eventInit = {}) {
        ...
        try {
            ...
            (0, util_js_1.assert)(e instanceof Error);
...
class SSEStreamTarget extends EventTarget {
    constructor(context, { headers, keepAlive = false } = {}) {
        ...
        tslib_1.__classPrivateFieldSet(this, _SSEStreamTarget_context, context, "f");
        context.response.body = new dntShim.ReadableStream({
            start: (controller) => {
                tslib_1.__classPrivateFieldSet(this, _SSEStreamTarget_controller, controller, "f");
            },
            cancel: (error) => {
                ...
                if (error instanceof Error && error.message.includes("connection closed")) {
                    ...
                    tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_instances, "m", _SSEStreamTarget_error).call(this, error);
                }
            },
        });
        if (headers) {
        ...
        this.addEventListener("close", () => {
            tslib_1.__classPrivateFieldSet(this, _SSEStreamTarget_closed, true, "f");
            if (tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_keepAliveId, "f") != null) {
                clearInterval(tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_keepAliveId, "f"));
                tslib_1.__classPrivateFieldSet(this, _SSEStreamTarget_keepAliveId, undefined, "f");
            }
            if (tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_controller, "f")) {
                try {
                    tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_controller, "f").close();
                }
                catch {
        ...
        if (keepAlive) {
            ...
            tslib_1.__classPrivateFieldSet(this, _SSEStreamTarget_keepAliveId, setInterval(() => {
                this.dispatchComment("keep-alive comment");
            }, interval), "f");
        }
    }
    get closed() {
        return tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_closed, "f");
    }
    close() {
    ...
    dispatchComment(comment) {
        tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_instances, "m", _SSEStreamTarget_push).call(this, `: ${comment.split("\n").join("\n: ")}\n\n`);
        return true;
    }
    // deno-lint-ignore no-explicit-any
    ...
    dispatchEvent(event) {
        ...
        if (dispatched && event instanceof ServerSentEvent) {
            tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_instances, "m", _SSEStreamTarget_push).call(this, String(event));
        }
        return dispatched;
    }
    [(_SSEStreamTarget_closed = new WeakMap(), _SSEStreamTarget_context = new WeakMap(), _SSEStreamTarget_controller = new WeakMap(), _SSEStreamTarget_keepAliveId = new WeakMap(), _SSEStreamTarget_instances = new WeakSet(), _SSEStreamTarget_error = function _SSEStreamTarget_error(error) {
        ...
        tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_context, "f").app.dispatchEvent(errorEvent);
    }, _SSEStreamTarget_push = function _SSEStreamTarget_push(payload) {
        if (!tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_controller, "f")) {
            tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_instances, "m", _SSEStreamTarget_error).call(this, new Error("The controller has not been set."));
            return;
        }
        if (tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_closed, "f")) {
            return;
        }
        tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_controller, "f").enqueue(encoder.encode(payload));
    }, Symbol.for("Deno.customInspect"))](inspect) {
        return `${this.constructor.name} ${inspect({ "#closed": tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_closed, "f"), "#context": tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_context, "f") })}`;
    }
    ...
    options, inspect) {
        ...
        return `${options.stylize(this.constructor.name, "special")} ${inspect({ "#closed": tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_closed, "f"), "#context": tslib_1.__classPrivateFieldGet(this, _SSEStreamTarget_context, "f") }, newOptions)}`;
    }
}
