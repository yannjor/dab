...
const http_server_flash_js_1 = require("./http_server_flash.js");
...
const keyStack_js_1 = require("./keyStack.js");
...
class Application extends EventTarget {
    constructor(options = {}) {
        ...
        Object.defineProperty(this, "handle", {
            ...
            value: (async (request, secureOrConn, secure = false) => {
                ...
                const context = new context_js_1.Context(this, contextRequest, tslib_1.__classPrivateFieldGet(this, _Application_instances, "m", _Application_getContextState).call(this), secure);
                try {
    ...
    set keys(keys) {
        if (!keys) {
            ...
            tslib_1.__classPrivateFieldSet(this, _Application_keys, new keyStack_js_1.KeyStack(keys), "f");
        }
        else {
    ...
    async listen(options = { port: 0 }) {
        ...
        const serverType = server instanceof http_server_node_js_1.HttpServer
            ? "native"
            : server instanceof http_server_flash_js_1.FlashServer
                ? "flash"
                : "custom";
    ...
    [(_Application_composedMiddleware = new WeakMap(), _Application_contextState = new WeakMap(), _Application_keys = new WeakMap(), _Application_middleware = new WeakMap(), _Application_serverConstructor = new WeakMap(), _Application_instances = new WeakSet(), _Application_getComposed = function _Application_getComposed() {
    ...
    async function _Application_handleRequest(request, secure, state) {
        const context = new context_js_1.Context(this, request, tslib_1.__classPrivateFieldGet(this, _Application_instances, "m", _Application_getContextState).call(this), secure);
        let resolve;
