...
class Buffer {
    ...
    readSync(p) {
        ...
        const nread = (0, mod_js_1.copy)(tslib_1.__classPrivateFieldGet(this, _Buffer_buf, "f").subarray(tslib_1.__classPrivateFieldGet(this, _Buffer_off, "f")), p);
    ...
    writeSync(p) {
        ...
        return (0, mod_js_1.copy)(p, tslib_1.__classPrivateFieldGet(this, _Buffer_buf, "f"), m);
    }
...
_Buffer_buf = new WeakMap(), _Buffer_off = new WeakMap(), _Buffer_instances = new WeakSet(), _Buffer_tryGrowByReslice = function _Buffer_tryGrowByReslice(n) {
    ...
    if (n <= Math.floor(c / 2) - m) {
        ...
        (0, mod_js_1.copy)(tslib_1.__classPrivateFieldGet(this, _Buffer_buf, "f").subarray(tslib_1.__classPrivateFieldGet(this, _Buffer_off, "f")), tslib_1.__classPrivateFieldGet(this, _Buffer_buf, "f"));
    }
        ...
        (0, mod_js_1.copy)(tslib_1.__classPrivateFieldGet(this, _Buffer_buf, "f").subarray(tslib_1.__classPrivateFieldGet(this, _Buffer_off, "f")), buf);
...
class BufReader {
    ...
    async read(p) {
        ...
        const copied = (0, mod_js_1.copy)(tslib_1.__classPrivateFieldGet(this, _BufReader_buf, "f").subarray(tslib_1.__classPrivateFieldGet(this, _BufReader_r, "f"), tslib_1.__classPrivateFieldGet(this, _BufReader_w, "f")), p, 0);
        ...
        while (avail < n && avail < tslib_1.__classPrivateFieldGet(this, _BufReader_buf, "f").byteLength && !tslib_1.__classPrivateFieldGet(this, _BufReader_eof, "f")) {
            try {
                ...
                if (err instanceof PartialReadError) {
                    ...
                    const e = new PartialReadError();
                    e.partial = tslib_1.__classPrivateFieldGet(this, _BufReader_buf, "f").subarray(tslib_1.__classPrivateFieldGet(this, _BufReader_r, "f"), tslib_1.__classPrivateFieldGet(this, _BufReader_w, "f"));
                    e.stack = err.stack;
                    e.message = err.message;
                    e.cause = err.cause;
                    throw err;
